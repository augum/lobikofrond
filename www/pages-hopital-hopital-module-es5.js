...
var HopitalPageModule = /** @class */ (function () {
    function HopitalPageModule() {
    }
...
var HopitalPage = /** @class */ (function () {
    function HopitalPage(router, hopitalservice, geolocation, toastctrl, geocoder) {
        this.router = router;
    ...
    HopitalPage.prototype.ngOnInit = function () {
    ...
    HopitalPage.prototype.afficherHopP = function () {
        var _this = this;
        this.geolocation.getCurrentPosition().then(function (position) {
            ...
            _this.geocoder.reverseGeocode(latitude, longitude, options).
                ...
                _this.hopitalservice.getHopitalp(localite)
                    .subscribe(function (data) {
                    _this.hopitauxp = data;
                }, function (err) {
                    console.log(err);
                });
            });
    ...
    HopitalPage.prototype.afficherHop = function (kw) {
        var _this = this;
    ...
    HopitalPage.prototype.creerHopital = function () {
        this.listHopitaux = 1;
        this.buttonPlus = 1;
        this.title = 'Création hôpital';
    };
    HopitalPage.prototype.retour = function () {
        this.listHopitaux = 0;
        this.buttonPlus = 0;
        this.title = 'Hôpitaux';
    };
    HopitalPage.prototype.loadData = function (event) {
        var _this = this;
        setTimeout(function () {
            console.log('Done');
            ...
            if (_this.hopitaux.length == 1000) {
                event.target.disabled = true;
            }
        }, 500);
    };
    HopitalPage.prototype.enregistrer = function (hopital) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                this.geolocation.getCurrentPosition().then(function (position) {
                    ...
                    _this.geocoder.reverseGeocode(hopital.latitude, hopital.longitude, options).
                        then(function (results) {
                        hopital.localite = results[0].subLocality;
                        hopital.ville = results[0].administrativeArea;
                        _this.hopitalservice.enregistrerMed(hopital)
    ...
    HopitalPage.prototype.DetailHopital = function (hopital) {
    ...
    HopitalPage.ctorParameters = function () { return [
...
var HopitalService = /** @class */ (function () {
    function HopitalService(httpclient) {
        this.httpclient = httpclient;
        this.host = "http://41.242.128.107:780";
    }
    HopitalService.prototype.getHopital = function (kw) {
        return this.httpclient.get(this.host + "/hopital?kw=" + kw);
    };
    HopitalService.prototype.getHopitalp = function (kw) {
        return this.httpclient.get(this.host + "/hopitalp?kw=" + kw);
    };
    HopitalService.prototype.enregistrerMed = function (hopital) {
        return this.httpclient.post(this.host + "/hopital", hopital);
    };
    HopitalService.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-hopital-hopital-module-es5.js.map