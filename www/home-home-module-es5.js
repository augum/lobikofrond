...
var HomePage = /** @class */ (function () {
    function HomePage(platform, route, socialSharing, likeService, toastctrl) {
        var _this = this;
    ...
    HomePage.prototype.medecin = function () {
        console.log("ok");
        this.route.navigate(["list"]);
    };
    HomePage.prototype.sharing = function () {
        this.socialSharing.share("", "", "", "https//lobiko.com");
    };
    HomePage.prototype.like = function () {
        var _this = this;
        this.likeService.afficherlike().subscribe(function (data) {
            _this.likes = data;
        });
    };
    HomePage.prototype.jaime = function (like) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.likeService.updatelike(like._id, like).subscribe(function (res) { });
    ...
    HomePage.prototype.apropos = function () {
