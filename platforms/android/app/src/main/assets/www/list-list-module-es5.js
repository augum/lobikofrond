...
var ListPage = /** @class */ (function () {
    function ListPage(platform, route, medecinService, toastctrl, socialSharing, likeService) {
    ...
    ListPage.prototype.offline = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            var _this = this;
    ...
    ListPage.prototype.afficherMed = function (kw) {
        var _this = this;
    ...
    ListPage.prototype.loadData = function (event) {
        ...
        setTimeout(function () {
            ...
            if (_this.medecins.length == 1000) {
                event.target.disabled = true;
            }
        }, 500);
    };
    ListPage.prototype.creermed = function () {
        this.listMed = 1;
        this.buttonPlus = 1;
        this.title = 'Création du médecin';
    };
    ListPage.prototype.enregistrer = function (medecinModels) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    ListPage.prototype.retour = function () {
        this.buttonPlus = 0;
        this.listMed = 0;
        this.title = 'Liste des medecins';
        this.afficherMed(this.kw);
    };
    ListPage.prototype.DetailMed = function (medecin) {
    ...
    ListPage.prototype.updateMed = function (medecin) {
    ...
    ListPage.prototype.sharing = function () {
        this.socialSharing.share('', '', '', 'https//lobiko.com');
    };
    ListPage.prototype.like = function () {
        var _this = this;
    ...
    ListPage.prototype.jaime = function (like) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
